...
def safe_get_json(oauth, path):
    """Call Yahoo Fantasy API and force JSON format, return {} if decode fails."""
...
def main():
    ...
    if not standings_root:
        print("Could not find standings in API response")
        return
